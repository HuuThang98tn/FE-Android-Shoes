...
public class ListSanPhamAdapter extends RecyclerView.Adapter<ListSanPhamAdapter.ListSanPhamAdapterViewHolder> implements Filterable {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ListSanPhamAdapterViewHolder holder, int position) {
        ...
        holder.tv_ngaySanXuat.setText(modelSanPham.getNgay_san_xuat());
        holder.tv_mieuTa.setText(modelSanPham.getMieuTaSP_());
    ...
    public class ListSanPhamAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_giaTien, tv_tenSanPham, tv_ngaySanXuat, tv_mieuTa, tv_xemChitiet, tv_Trangthai;
        ...
        public ListSanPhamAdapterViewHolder(@NonNull @NotNull View itemView) {
            ...
            tv_ngaySanXuat = itemView.findViewById(R.id.textView14);
            tv_mieuTa = itemView.findViewById(R.id.textView12);

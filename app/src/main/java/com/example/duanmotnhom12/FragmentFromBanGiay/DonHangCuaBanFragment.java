...
public class DonHangCuaBanFragment extends Fragment {
    ...
    public DonHangCuaBanFragment() {
        // Required empty public constructor
    }


    public static DonHangCuaBanFragment newInstance(String param1, String param2) {
        DonHangCuaBanFragment fragment = new DonHangCuaBanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_don_hang_cua_ban, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        Toolbar tb_dangKy = view.findViewById(R.id.tb_donHang);

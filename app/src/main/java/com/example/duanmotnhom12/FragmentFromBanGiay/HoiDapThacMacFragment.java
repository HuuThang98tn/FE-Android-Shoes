...
public class HoiDapThacMacFragment extends Fragment {
    ...
    public HoiDapThacMacFragment() {
        // Required empty public constructor
    }


    public static HoiDapThacMacFragment newInstance(String param1, String param2) {
        HoiDapThacMacFragment fragment = new HoiDapThacMacFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_hoi_dap_thac_mac, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        Toolbar tb_dangKy = view.findViewById(R.id.tb_hoidap);
